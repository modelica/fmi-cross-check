Model Description:
	This model is a symmetric-key algorithm for the encryption of electronic data implementation design exported with HIFSuite starting from a VHDL description.
