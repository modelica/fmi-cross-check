Model:
	...
	Command to run with checker:
	    ...
	    fmuCheck.win32.exe -e %FMUName%_cc.txt -o %FMUName%_cc.csv -h 1 -s 4 %FMUName%.fmu
	
	Folder contents:
	    Circle.fmu                         FMU exported with ASim 2017
	    Circle_ref.csv                     Result file from simulation using ASim 2017
