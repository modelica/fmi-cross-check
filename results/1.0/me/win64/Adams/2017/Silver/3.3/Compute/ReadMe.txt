...
Notes:
All outputs match. Provided a output timestep of 0.010000001 (as opposed to 0.01). Providing 0.01 is causing a results mismatch due to the events not being handled properly