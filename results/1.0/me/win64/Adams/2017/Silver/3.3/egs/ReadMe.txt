...
Reason for failure:
The outputs egsGear, egsTargetGear, valves_eds2, valves_eds3, valves_eds5 and valves_mv1 do not match with the reference. Provided a output timestep of 0.01000000001 (as opposed to 0.01). Providing 0.01 is causing a results mismatch due to the events not being handled properly