...
Reason for failure:
Adams does not currently support reading any variables from the FMU other than those with causality = output. Since, this model does not have any such variables, we just mark this test as rejected.