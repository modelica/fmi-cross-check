Tested using: OPTIMICA_Studio, version 1.2a4

Tested FMU: ModelExchange\LMS_Virtual.Lab_Motion\Rev11SL2\win32\SHUNTDCMOTORWITHSTARTINGRESISTOR.fmu

Log output can be found in 'log.txt' 
...
Simulating from t=0.0 to t=1 (Could not interpret final time)

Input:  None (Unmatched: None)
Output: All variables in the FMU

Failed to simulate the FMU, see the 'log.txt' and the 'exception.txt'...
