...
FMU used:
  Path='../../../../../../../../../Test_FMUs/FMI_1.0/CoSimulation/win32/Silver/2.6.0.312_alpha12/Lights_Control/lights_control.fmu'
  Identifier='lights_control'
Notes:
...
Results:
  ...
  Difference in results is due to interpolation of reference results which are not on equidistant time grid
