...
Tested FMU: CoSimulation\win64\CATIA\R2014x\Modelica_Electrical_Digital_Examples_DFFREG.fmu
...
Results:
  ...
  Record was done during the executable simulation.
  Also only the following variables are recorded: dFFREG.dataOut[1] and dFFREG.dataOut[2]
