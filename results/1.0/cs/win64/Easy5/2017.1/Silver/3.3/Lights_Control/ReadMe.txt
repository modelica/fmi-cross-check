...
Note: This FMU runs in Easy5  

       1) only with Visual Studio/Intel Fortran compilers.  (Failure is expected with GNU compilers)
       2) the environment variable DIS_FPE_TRAP must be set before starting Easy5.
