...
Model:
 CoSimulation\win32\SimulationX\3.5.707\ControlledTemperature\ControlledTemperature.fmu
...
Simulation information:
 - Start time: 0.0
 - Final time: 10
 - Input variables:  None (Unmatched: ['t', 'ramp.y'])
 - Output variables: ['time', 'onOffController.reference', 'temperatureSensor.port.T']
