...
Model:
  CoSimulation\win32\SimulationX\3.5.707\Engine1b\Engine1b.fmu
...
Simulation information:
 - Start time: 0.0
 - Final time: 1.5
 - Input variables:  None (Unmatched: None)
 - Output variables: ['time', 'Piston.frame_a.r_0[1]', 'Piston.frame_a.r_0[2]', 'Piston.frame_a.r_0[3]']
