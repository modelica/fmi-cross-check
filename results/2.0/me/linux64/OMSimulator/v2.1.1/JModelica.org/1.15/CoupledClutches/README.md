...
```bash
> .omsimulator/OMSimulator-linux-amd64-v2.1.1/bin/OMSimulator --workingDir=results/2.0/me/linux64/OMSimulator/v2.1.1/JModelica.org/1.15/CoupledClutches --stripRoot=true --skipCSVHeader=true --addParametersToCSV=true --suppressPath=true --timeout=60 CoupledClutches.lua
```
...
oms_addSubModel('model.root.input', '../../../../../../../../../fmus/2.0/me/linux64/JModelica.org/1.15/CoupledClutches/CoupledClutches_in.csv')
