# Notes on import of TestModel2_sf.fmu

## Importing Tool

The FMU TestModel2_sf.fmu was imported with 4.0.4.60382 (08/27/19) x64 using a CVODE solver.
...
|Option|Value|
|-----:|:----|
|ToleranceX|5.000000E-002|
|ToleranceY|5.000000E-002|
