# Notes on import of CoupledClutches.fmu

## Importing Tool

The FMU CoupledClutches.fmu was imported with 4.0.4.60382 (08/27/19) x64 using a FixStep solver.
...
|Option|Value|
|-----:|:----|
|ToleranceX|4.000000E-003|
|ToleranceY|4.000000E-003|
