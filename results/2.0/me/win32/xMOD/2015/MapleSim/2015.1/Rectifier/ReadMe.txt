Test case name    : FMI2_ME_MapleSim_2015.1_Rectifier
FMU name          : Rectifier.fmu
Performed with    : xMOD 2015
Date              : 22-Dec-2015 11:11:00

To run the example with xMOD :

    1. Download a trial version of xMOD at http://www.xmodsoftware.com
    2. Double clic the FMI2_ME_MapleSim_2015.1_Rectifier.zsimu file to import and open it in xMOD
    ...
    4. Result file will be generated with extension .002 under the FMI2_ME_MapleSim_2015.1_Rectifier simulation directory under xMOD bench root directory

 Matlab figures (.fig files) of the obtained resulats are also available
 
 Cause of failure : numerical instability. No available solver is able to tackle this test-case
