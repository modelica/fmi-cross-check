...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu FmuExportCrossCompile.fmu -opt FmuExportCrossCompile_ref.opt -ref FmuExportCrossCompile_ref.csv
```
