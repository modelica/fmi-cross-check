...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu TriangleSource.fmu -opt TriangleSource_ref.opt -ref TriangleSource_ref.csv
```
