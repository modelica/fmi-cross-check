...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu Threetank.fmu -opt Threetank_ref.opt -ref Threetank_ref.csv
```
