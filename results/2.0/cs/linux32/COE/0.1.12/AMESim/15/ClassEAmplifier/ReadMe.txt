...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu ClassEAmplifier.fmu -opt ClassEAmplifier_ref.opt -ref ClassEAmplifier_ref.csv
```
