...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu SquareSource.fmu -opt SquareSource_ref.opt -ref SquareSource_ref.csv
```
