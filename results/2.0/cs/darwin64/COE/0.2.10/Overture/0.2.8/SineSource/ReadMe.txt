...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu SineSource.fmu -opt SineSource_ref.opt -ref SineSource_ref.csv
```
