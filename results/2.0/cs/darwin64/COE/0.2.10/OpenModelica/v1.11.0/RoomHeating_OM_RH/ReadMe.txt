...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu RoomHeating_OM_RH.fmu -opt RoomHeating_OM_RH_ref.opt -ref RoomHeating_OM_RH_ref.csv
```
