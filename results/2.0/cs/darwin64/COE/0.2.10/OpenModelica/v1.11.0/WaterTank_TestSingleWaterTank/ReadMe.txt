...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu WaterTank_TestSingleWaterTank.fmu -opt WaterTank_TestSingleWaterTank_ref.opt -ref WaterTank_TestSingleWaterTank_ref.csv
```
