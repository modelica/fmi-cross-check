...
Notes:
The first output outputs[1] matches with the values in the vendor provided reference csv. The other three outputs do not match. However, they match with the values in the FMU cross check reference csv.