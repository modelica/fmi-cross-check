...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu fuelrail_cs.fmu -opt fuelrail_cs_ref.opt -ref fuelrail_cs_ref.csv
```
