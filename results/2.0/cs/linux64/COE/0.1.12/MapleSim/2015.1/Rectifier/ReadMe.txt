...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu Rectifier.fmu -opt Rectifier_ref.opt -ref Rectifier_ref.csv
```
