...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN --min-stepsize 0.001 -fmu CauerLowPassAnalog.fmu -opt CauerLowPassAnalog_ref.opt -ref CauerLowPassAnalog_ref.csv
```
