...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN --min-stepsize 0.001 -fmu PID_Controller.fmu -opt PID_Controller_ref.opt -ref PID_Controller_ref.csv
```
