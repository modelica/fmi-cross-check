...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu TorsionBar.fmu -opt TorsionBar_ref.opt -ref TorsionBar_ref.csv
```
