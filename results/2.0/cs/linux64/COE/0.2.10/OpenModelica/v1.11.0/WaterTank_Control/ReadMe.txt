...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu WaterTank_Control.fmu -opt WaterTank_Control_ref.opt -ref WaterTank_Control_ref.csv
```
