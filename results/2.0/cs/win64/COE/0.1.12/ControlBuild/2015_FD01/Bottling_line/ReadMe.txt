...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu bottling_line.fmu -opt bottling_line_ref.opt -ref bottling_line_ref.csv
```
