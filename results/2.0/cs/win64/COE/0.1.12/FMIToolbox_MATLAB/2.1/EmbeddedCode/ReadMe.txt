...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu EmbeddedCode.fmu -opt EmbeddedCode_ref.opt -ref EmbeddedCode_ref.csv
```
