...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu Continuous.fmu -opt Continuous_ref.opt -ref Continuous_ref.csv
```
