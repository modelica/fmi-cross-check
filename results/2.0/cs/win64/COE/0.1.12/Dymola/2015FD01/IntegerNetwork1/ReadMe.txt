...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu IntegerNetwork1.fmu -opt IntegerNetwork1_ref.opt -ref IntegerNetwork1_ref.csv
```
