...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu BooleanNetwork1.fmu -opt BooleanNetwork1_ref.opt -ref BooleanNetwork1_ref.csv
```
