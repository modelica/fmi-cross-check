...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu vanDerPol.fmu -opt vanDerPol_ref.opt -ref vanDerPol_ref.csv
```
