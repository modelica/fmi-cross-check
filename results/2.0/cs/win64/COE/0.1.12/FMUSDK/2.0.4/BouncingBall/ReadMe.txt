...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu bouncingBall.fmu -opt bouncingBall_ref.opt -ref bouncingBall_ref.csv
```
