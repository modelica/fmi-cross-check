...
Reason for failure:
Error occurred when parsing model description xml. Error thrown is "module = FMI2XML, log level = FATAL: Parsing XML element 'fmiModelDescription': required attribute 'numberOfEventIndicators' not found"