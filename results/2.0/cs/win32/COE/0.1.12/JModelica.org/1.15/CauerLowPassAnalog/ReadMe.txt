...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu CauerLowPassAnalog.fmu -opt CauerLowPassAnalog_ref.opt -ref CauerLowPassAnalog_ref.csv
```
