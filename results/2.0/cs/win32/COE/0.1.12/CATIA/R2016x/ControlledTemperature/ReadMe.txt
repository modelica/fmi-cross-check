...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu ControlledTemperature.fmu -opt ControlledTemperature_ref.opt -ref ControlledTemperature_ref.csv
```
