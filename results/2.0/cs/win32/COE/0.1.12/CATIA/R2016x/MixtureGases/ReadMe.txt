...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu MixtureGases.fmu -opt MixtureGases_ref.opt -ref MixtureGases_ref.csv
```
