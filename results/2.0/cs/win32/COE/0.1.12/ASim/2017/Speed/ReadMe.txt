...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu Speed_SWC.fmu -opt Speed_SWC_ref.opt -ref Speed_SWC_ref.csv
```
