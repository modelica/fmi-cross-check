...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu Circle_SWC.fmu -opt Circle_SWC_ref.opt -ref Circle_SWC_ref.csv
```
