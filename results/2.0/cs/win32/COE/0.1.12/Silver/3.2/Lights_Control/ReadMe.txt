...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu lights_control.fmu -opt lights_control_ref.opt -ref lights_control_ref.csv
```
