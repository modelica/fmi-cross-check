...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu TestModel2_sf.fmu -opt TestModel2_sf_ref.opt -ref TestModel2_sf_ref.csv
```
