...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu IntegrateSignal.fmu -opt IntegrateSignal_ref.opt -ref IntegrateSignal_ref.csv
```
