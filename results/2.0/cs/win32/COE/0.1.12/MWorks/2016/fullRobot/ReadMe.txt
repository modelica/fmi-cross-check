...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu fullRobot.fmu -opt fullRobot_ref.opt -ref fullRobot_ref.csv
```
