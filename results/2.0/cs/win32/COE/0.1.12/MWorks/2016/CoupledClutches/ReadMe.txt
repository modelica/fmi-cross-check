...
```
java -cp coe.jar org.intocps.orchestration.coe.single.SingleSimMain -xplot -readme -level WARN -fmu CoupledClutches.fmu -opt CoupledClutches_ref.opt -ref CoupledClutches_ref.csv
```
