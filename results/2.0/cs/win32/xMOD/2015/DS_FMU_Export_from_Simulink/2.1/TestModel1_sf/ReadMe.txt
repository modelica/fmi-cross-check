Test case name    : FMI2_CS_DS_FMU_Export_from_Simulink_2.1_TestModel1_sf
FMU name          : TestModel1_sf.fmu
Performed with    : xMOD 2015
Date              : 21-Dec-2015 10:05:52

To run the example with xMOD :

    1. Download a trial version of xMOD at http://www.xmodsoftware.com
    2. Double clic the FMI2_CS_DS_FMU_Export_from_Simulink_2.1_TestModel1_sf.zsimu file to import and open it in xMOD
    ...
    4. Result file will be generated with extension .002 under the FMI2_CS_DS_FMU_Export_from_Simulink_2.1_TestModel1_sf simulation directory under xMOD bench root directory
