Test case name    : FMI2_CS_FMIToolbox_MATLAB_2.1_IntegrateSignal
FMU name          : IntegrateSignal.fmu
Performed with    : xMOD 2015
Date              : 21-Dec-2015 13:28:57

To run the example with xMOD :

    1. Download a trial version of xMOD at http://www.xmodsoftware.com
    2. Double clic the FMI2_CS_FMIToolbox_MATLAB_2.1_IntegrateSignal.zsimu file to import and open it in xMOD
    ...
    4. Result file will be generated with extension .002 under the FMI2_CS_FMIToolbox_MATLAB_2.1_IntegrateSignal simulation directory under xMOD bench root directory
